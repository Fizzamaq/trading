...
<div class="container mx-auto max-w-7xl p-8">
    <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{ route('director.inventory.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-semibold transition duration-200">
                Add Item
            </a>
        </div>
    </div>
            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                @forelse ($inventoryItems as $item)
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-gray-600">{{ $item->lot_number ?? 'N/A' }}</td>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-gray-900">PKR {{ number_format($item->unit_cost, 2) }}</td>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-sm font-medium space-x-2">
                            <a href="{{ route('director.inventory.show', $item->id) }}" class="text-blue-600 hover:text-blue-900">View</a>
                            <a href="{{ route('director.inventory.edit', $item->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                        </td>
                    </tr>
                @empty
                    <tr>
