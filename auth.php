...
return [
    ...
    */
    ...
    |
    | You may configure multiple user providers if you have multiple types
    | of users or data sources. These providers represent different ways
    | your users can be authenticated.
    |
    ...
    */
    ...
    | more than one user provider and want to customize rules separately.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option defines the number of seconds before a password confirmation
